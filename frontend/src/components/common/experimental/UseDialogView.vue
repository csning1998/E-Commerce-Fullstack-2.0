...
// Reformatted from: https://github.com/thefaiz/vue-dialog
...
<template>
   <div>
      <div class="mt-10 text-center">
         <button @click="showDialog = true" class="btn">Delete Task</button>
         <button @click="showDialogUser = true" class="btn">Delete User</button>
      </div>
